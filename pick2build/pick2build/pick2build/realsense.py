...
class ImgNode(Node):
    def __init__(self):
        ...
        self.color_subscription = self.create_subscription(
            Image, '/dsr01/camera/color/image_raw', self.color_callback, 10)
        self.depth_subscription = self.create_subscription(
            Image, '/dsr01/camera/aligned_depth_to_color/image_raw', self.depth_callback, 10)
        self.camera_info_subscription = self.create_subscription(
            CameraInfo, '/dsr01/camera/color/camera_info', self.camera_info_callback, 10)
